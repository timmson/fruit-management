...
{section name=i loop=$structtasks}
	{if $structtasks[i].tm_state_name ne 'declie' and $structtasks[i].tm_state_name ne 'done'}
		{assign var=plan_hour value=$structtasks[i].tm_plan_hour+$plan_hour}
		{assign var=all_hour value=$structtasks[i].tm_all_hour+$all_hour} 
	{/if}
{/section}
<div id="tabs">
	<ul>
...
<div id="planTab">
	<table class="container" style="table-layout: fixed;">
		<tr>
			<th>Резерв</th>
			{section name=i loop=$structtasks}
			<th>{$structtasks[i].tm_code}.{$structtasks[i].tm_descr}</th>
			{/section}
		</tr>
		<tr>
		...
		<tr>
			<td style="padding: 5px; vertical-align: top;">
				<div class="droppable" id="new" title="state">
	   			{section name=i loop=$structtasks}
					{section name=j loop=$structtasks[i].child}
						{if $structtasks[i].child[j].tm_state_name eq 'new'}
							{include file="agileeditorcard.tpl" task=$structtasks[i].child[j]}
						{/if}
					{/section}
				{/section}
			...
			<td style="padding: 5px; vertical-align: top;">
				<div class="droppable" id="planned" title="state">
	   			{section name=i loop=$structtasks}
					{section name=j loop=$structtasks[i].child}
						{if $structtasks[i].child[j].tm_state_name eq 'planned'}
							{include file="agileeditorcard.tpl" task=$structtasks[i].child[j]}
						{/if}
					{/section}
				{/section}
			...
			<td style="padding: 5px; vertical-align: top;">
				<div class="droppable" id="in_progress" title="state">
	   			{section name=i loop=$structtasks}
					{section name=j loop=$structtasks[i].child}
						{if $structtasks[i].child[j].tm_state_name eq 'in_progress'}
							{include file="agileeditorcard.tpl" task=$structtasks[i].child[j]}
						{/if}
					{/section}
				{/section}
			...
			<td style="padding: 5px; vertical-align: top;">
				<div class="droppable" id="test" title="state">
	   			{section name=i loop=$structtasks}
					{section name=j loop=$structtasks[i].child}
						{if $structtasks[i].child[j].tm_state_name eq 'test'}
							{include file="agileeditorcard.tpl" task=$structtasks[i].child[j]}
						{/if}
					{/section}
				{/section}

...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `fruit` /*!40100 DEFAULT CHARACTER SET cp1251 COLLATE cp1251_general_cs */;
...
CREATE TABLE `fm_cat_log` (
  ...
  `fm_name` varchar(100) collate cp1251_general_cs NOT NULL,
  `fm_descr` varchar(255) collate cp1251_general_cs NOT NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE `fm_project` (
  ...
  `fm_name` varchar(100) collate cp1251_general_cs NOT NULL,
  `fm_descr` varchar(255) collate cp1251_general_cs NOT NULL,
  `fm_manager` varchar(255) collate cp1251_general_cs NOT NULL,
...
CREATE TABLE `fm_subscribe` (
  ...
  `fm_user` varchar(25) collate cp1251_general_cs NOT NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE `fm_task` (
  `id` int(11) NOT NULL auto_increment,
  `fm_name` varchar(100) collate cp1251_general_cs NOT NULL,
  `fm_descr` varchar(255) collate cp1251_general_cs default NULL,
...
CREATE TABLE `fm_work_log` (
  ...
  `fm_comment` varchar(255) collate cp1251_general_cs default NULL,
  `fm_user` varchar(25) collate cp1251_general_cs default NULL,
  PRIMARY KEY  (`id`),
